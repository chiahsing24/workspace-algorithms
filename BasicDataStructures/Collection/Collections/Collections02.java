public class Collections02 {
    public static void main(String[] args) {
         ...
         * The binarySearch(List list, T key) method searches the specified list for the specified object using the
         * binary search algorithm. The elements added in the List must implement the Comparable interface, and the list
         * must be sorted into ascending order before making this call. If it is not sorted, the results are undefined.
         * If the list contains multiple elements equal to the specified object, there is no guarantee which one will be
         * found.
         *
         ...
         * {1,2,3,40,50,60}
         *
         * So the copy() method does not merge the elements of the two lists. It replaces the elements in the destination
         * list from the elements in the source list.
         */
